      ...
      `}</style>
        ...
        <main className="relative mx-auto max-w-6xl px-4">
          ...
          <section id="about" className="relative scroll-mt-24 py-20">
            ...
            <svg
              ...
              viewBox="0 0 1000 100"
              preserveAspectRatio="none"
              className="absolute bottom-0 left-1/2 right-1/2 -mx-[50vw] w-screen h-4 sm:h-10 block z-10"
              style={{ marginBottom: "-1px", overflow: "visible" }}
            >
              <path d="M0,50 Q250,-35 500,50 T1000,50 L1000,100 L0,100 Z" fill="#fff" stroke="none" />
            </svg>
          </section>
          ...
          <section id="drawings" className="relative scroll-mt-24">
            ...
            <svg
              ...
              viewBox="0 0 1000 100"
              preserveAspectRatio="none"
              className="absolute top-0 left-1/2 right-1/2 -mx-[50vw] w-screen h-4 sm:h-10 block z-10"
              style={{ marginTop: "-1px", overflow: "visible" }}
            >
              <path d="M0,50 Q250,-35 500,50 T1000,50 L1000,0 L0,0 Z" fill="#fff" stroke="none" />
            </svg>
            <svg
              aria-hidden
              viewBox="0 0 1000 100"
        ...
        >
          <svg
            ...
            viewBox="0 0 1000 100"
            preserveAspectRatio="none"
            className="absolute top-0 left-0 right-0 w-full h-4 sm:h-10 block z-10"
            style={{ marginTop: "-1px", overflow: "visible" }}
          >
            <path d="M0,50 Q250,-35 500,50 T1000,50 L1000,0 L0,0 Z" fill="#fff" stroke="none" />
          </svg>
