      ...
      <footer className="relative text-[#e3d9cd] bg-neutral-900 border-t border-black/10 backdrop-blur">
        ...
        <div className="mx-auto max-w-6xl px-6 py-20">
          <div className="grid gap-8 md:grid-cols-3 md:items-center">
            {/* Left: quote */}
            <div className="order-2 md:order-1 flex items-center justify-center md:justify-start gap-4 text-xs opacity-80">
              <span className="h-14 w-px bg-[#e3d9cd]/40" aria-hidden="true" />
